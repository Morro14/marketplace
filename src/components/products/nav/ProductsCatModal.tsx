...
export default function ProductsCatModal({
  ...
  return (
    <div className="products-cats-modal drop-shadow-lg bg-bg flex flex-col justify-between p-12">
      {/* responsive */}
      ...
      <div className="flex gap-2">
        ...
        <button className="bg-gray-light px-6 border border-primary h-8">
          {t("Cancel")}
        </button>
      </div>
    </div>
