...
export default async function Basket() {
  ...
  return (
    <div className="w-full h-full flex">
      <div className="relative flex w-full sm:flex-row max-sm:flex-col sm:gap-5 gap-3">
        <div className="flex w-full flex-col 2xl:w-[1152px] max-lg:h-[calc(100dvh-88px)] overflow-y-scroll">
          <TopBar></TopBar>
